...
service_table_info <- names(mbta_change_summaries_highlevel) %>%
  ...
  arrange(
    ...
    desc(statistic))
```
TODO: total pct chg in trips and minutes across route categories,
...
adjustments_to_plot <- c('Winter 2025 (BNR Phase 1)', 'Spring 2024', 'GLX Medford Opening')
...
TODO: 
- add total affected pop & avg or total change in access per pre-existing access bin (not population ntile)
...
TODO: version by white/nonwhite only to reflect Title VI requirement
